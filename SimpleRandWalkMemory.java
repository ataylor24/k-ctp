...
public class SimpleRandWalkMemory extends Algorithm {
    ...
    private Edge findNextNodeWithMemConstraint(Node curNode, int size) {
        ...
        for (int i = 0; i < curNode.edgeList.size(); ++i) {
            // build an arrayList of viable edges by for loop, and then randomly choose from that
            // size
...
/*
 * Location: /Users/alextaylor/Desktop/sim_class_v15/!/SimpleRandWalkMemory.class Java compiler
