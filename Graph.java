...
public class Graph {
    ...
    public Graph(Graph superGraph, ArrayList<Edge> removalIndices) {
        ...
        for (int i = 0; i < superGraph.nodeList.size(); ++i) {
            ...
            if (newNode.equals(superGraph.start))
                this.start = newNode;
            if (newNode.equals(superGraph.target))
                this.target = newNode;
        }
...
/*
 * Location: /Users/alextaylor/Desktop/sim_class_v15/!/Graph.class Java compiler version: 9 (53.0)
